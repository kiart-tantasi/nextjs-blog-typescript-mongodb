            ...
            <ul>
                ...
                <li>
                    <a href='https://reactjs.org/' target='_blank' rel='noopener noreferrer'>
                        <img className={styles.react} src='/images/HowIBuild/HowIBuild4.svg' alt='react' />
                    </a>
                </li>
                <li>
                    <a href='https://www.mongodb.com/' target='_blank' rel='noopener noreferrer'>
                        <img className={styles.mongodb} src='/images/HowIBuild/HowIBuild5.svg' alt='MongoDB' />
                    </a>
                </li>
                <li>
                    <a href='https://marked.js.org/' target='_blank' rel='noopener noreferrer'>
                        <img className={styles.marked} src='/images/HowIBuild/HowIBuild6.svg' alt='Marked' />
                    </a>
                </li>
                <li>
                    <a href='https://mui.com/' target='_blank' rel='noopener noreferrer'>
                        <img className={styles.mui} src='/images/HowIBuild/HowIBuild7.png' alt='material ui' />
                    </a>
                </li>
                <li>
                    <a href='https://github.com/auth0/node-jsonwebtoken' target='_blank' rel='noopener noreferrer'>
                        <img src='/images/HowIBuild/HowIBuild8.svg' alt='JWT' />
                    </a>
                </li>
                ...
                <li>
                    <a
                        ...
                        rel='noopener noreferrer'
                    >
                        <img src='/images/HowIBuild/HowIBuildGitHub.png' alt='GitHub' className={styles.github} />
                    </a>
                </li>
            </ul>
        </div>
