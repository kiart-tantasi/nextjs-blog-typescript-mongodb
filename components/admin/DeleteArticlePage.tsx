    ...
    return (
        <>
            ...
            {permanentDeleteModal && (
                <ModalUI
                    text='!!! โปรดพิมพ์ slug เพื่อลบถาวร !!!'
                    important
            ...
            <div style={{ paddingRight: 30, paddingTop: 15, textAlign: 'right' }}>
                <Button color='success' size='large' onClick={() => setRecoverModal(true)}>
                    กู้คืน
                </Button>
                <Button color='error' onClick={() => setPermanentDeleteModal(true)}>
                    ลบถาวร
                </Button>
            </div>
            <ArticleCardUI
